...
import { BrandDashboardBarGraph } from '../MainSecAfterLogin/BrandDashboardBarGraph';
import MetricsView from '../MainSecAfterLogin/Metrics';
...
export const Routing = () => {
  return (
    <Routes>
      ...
      <Route path="/HomePage" element={<AfterLoginMainPage />} />
      <Route path="/InfluencerProfileView/:id" element={<InfluencerProfileView />} />
      ...
      {/* Brand Dashboard Layout + Nested Routes */}
      <Route path="/" element={<BrandSideBar />}>
        <Route
     ...
     {/* Influencer Dashboard Layout + Nested Routes */}
